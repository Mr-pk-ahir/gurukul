...
export default function AdmissionRequestPage() {
  ...
  const columns = [
    {
      header: "Req ID",
      className: `w-24 text-center font-mono font-bold ${theme ? "text-blue-400" : "text-gray-800"}`,
      accessor: (req: AdmissionRequest) => `#${req.id}`,
    },
    {
      header: "Applicant Name",
      className: `text-left font-semibold ${theme ? "text-neutral-200" : "text-gray-800"}`,
      accessor: (req: AdmissionRequest) => req.applicantName,
    },
    {
      header: "Role",
    ...
    {
      header: "Date",
      className: `text-center text-sm ${theme ? "text-gray-500" : "text-gray-500"}`,
      accessor: (req: AdmissionRequest) => req.requestDate,
    },
    {
      header: "Actions",
  ...
  return (
    <div className="p-6 space-y-6 max-w-full mx-auto">
      <div>
        <h2 className={`text-2xl font-black ${theme ? "text-blue-400" : "text-gray-900"}`}>
          Admission Pipeline
        </h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-md">
        ...
        >
          <span className="flex items-center gap-2">
            <HiOutlineClock /> Pending Requests
          </span>
        ...
        >
          <span className="flex items-center gap-2">
            <HiOutlineCheckCircle /> Approved Outbox
          </span>
